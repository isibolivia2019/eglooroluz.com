      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper" class=" grey lighten-3">
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Agregar Nuevo Usuario</h5>
                <ol class="breadcrumb">
        ...
        <div class="container">
          <div class="section">
            ...
            <p class="caption">Registre un nuevo Usuario al Sistema.</p>
          ...
          <div class="row">
            <div class="col s12 m12 l12">
              <div class="card-panel">
                <h4 class="header2">llene el Siguiente Formulario</h4>
                <div class="row">
                  <form class="col s12">
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <input id="email5" type="text">
                        <label for="email">Direccion de Domicilio</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s12">
                    ...
                    <div class="row">
                      <div class="input-field col s12">
                        <input id="email5" type="text">
                        <label for="email">Nombre (s) y Apellidos de referencia</label>
                      </div>
                    </div>
                    <div class="row">
                      <div class="input-field col s6">
                        <input id="email5" type="email">
                        <label for="email">Celular / Tel Ref</label>
                      </div>
                      <div class="input-field col s6">
                        <select>
