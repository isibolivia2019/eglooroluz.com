...
class Inventario{
	...
	$sql = "SELECT cod_inventario, cod_almacenamiento, cod_item_producto, imagen_producto, nombre_producto, cant_producto, compra_unit_producto, precio_sugerido_venta FROM inventario, producto WHERE inventario.cod_producto = producto.cod_producto and inventario.cod_producto = ? and inventario.cod_almacenamiento = ? and inventario.compra_unit_producto = ? and inventario.precio_sugerido_venta = ?";
		return $this->db->select($sql, $datos);
	}
