        ...
        <div class="ps-container">
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <div class="ps-site-info site-info"><a class="ps-logo" href="index-2.html"><img src="public/images/logo.png" alt=""></a>
        ...
        <div class="ps-container">
            <div class="row">
                <div class="col-lg-8 col-md-7 col-sm-12 col-xs-12 ">
                    <p><a href="http://www.isibolivia.com">ISI BOLIVIA</a></p>
                </div>
                <div class="col-lg-4 col-md-5 col-sm-12 col-xs-12 ">
                    <div class="ps-footer__payment-methods">
                        <a href="#"><img src="public/images/payment-method/paypal.png" alt=""></a>
                        <a href="#"><img src="public/images/payment-method/visa.png" alt=""></a>
                        <a href="#"><img src="public/images/payment-method/master-card.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
