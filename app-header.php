    ...
    <div class="navbar-fixed">
        <nav class="cyan">
            <div class="nav-wrapper">
                <h1 class="logo-wrapper"><a href="index.html" class="brand-logo darken-1"><img src="public/images/materialize-logo.png" alt="materialize logo"></a> <span class="logo-text">Importadora ORO LUZ</span></h1>
